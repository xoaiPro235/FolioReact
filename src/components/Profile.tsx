    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 sm:p-8">
            <div className="max-w-2xl mx-auto">
                <button onClick={goToWorkspace} className="flex items-center text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 mb-6">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                    ...
                    {/* Danger Zone */}
                    <div className="p-8 bg-red-50 dark:bg-red-900/10">
                        ...
                        <button 
                            ...
                            className="border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2"
                        >

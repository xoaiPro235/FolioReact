...
export const TaskModal: React.FC = () => {
  const { users, currentUser, currentProject, addNotification, deleteTask, addComment, tasks, patchTask, selectedTaskId, setSelectedTask, addAttachment, removeAttachment } = useStore();
